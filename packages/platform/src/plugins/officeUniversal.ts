...
async function loadWasm(): Promise<void> {
  ...
  try {
    const mod = await import('../../../../crates/fmt-office-universal/pkg/viewit_fmt_office_universal.js');
    await mod.default();
...
export async function renderOffice(bytes: Uint8Array, ext: string): Promise<OfficeUniversalRenderResult> {
  await loadWasm();
