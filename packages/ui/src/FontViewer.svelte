...
<article class="font-viewer">
  <div class="preview">
    <p
      class="sample"
      style="font-family: {fontFamily}; font-weight: {weight}; font-style: {is_italic
        ? 'italic'
        : 'normal'}"
    >
    ...
    <p
      ...
      style="font-family: {fontFamily}; font-weight: {weight}; font-style: {is_italic
        ...
        : 'normal'}"
    >
      Āā Ăă Ąą Çç Čč Ďď Đđ Ēē Ĕĕ Ėė Ęę Ěě Ĝĝ Ğğ Ġġ Ģģ Ĥĥ Ħħ Ĩĩ Īī Ĭĭ Įį İı Ĳĳ Ĵĵ Ķķ ĸ Ĺĺ Ļļ Ľľ Ŀŀ Łł
      Ńń Ņņ Ňň ŉ Ŋŋ Ōō Ŏŏ Őő Œœ Ŕŕ Ŗŗ Řř Śś Ŝŝ Şş Šš Ţţ Ťť Ŧŧ Ũũ Ūū Ŭŭ Ůů Űű Ųų Ŵŵ Ŷŷ Ÿÿ Źź Żż Žž
    </p>
  </div>
  <aside class="meta">
