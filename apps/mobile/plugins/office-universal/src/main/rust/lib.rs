//! ViewIt Android Native Plugin for Unified Office Formats.
//!
...
#[no_mangle]
pub extern "system" fn Java_ai_viewit_plugins_officeuniversal_OfficeUniversalPlugin_nativeCanHandleMimeType(
    mut env: JNIEnv,
    _class: JClass,
    mime_type: JString,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_ai_viewit_plugins_officeuniversal_OfficeUniversalPlugin_nativeCanHandleExt(
    mut env: JNIEnv,
    _class: JClass,
    ext: JString,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_ai_viewit_plugins_officeuniversal_OfficeUniversalPlugin_nativeRender(
    mut env: JNIEnv,
    _class: JClass,
    file_path: JString,
    ext: JString,
...
#[no_mangle]
pub extern "system" fn Java_ai_viewit_plugins_officeuniversal_OfficeUniversalPlugin_nativeRenderBytes(
    mut env: JNIEnv,
    _class: JClass,
...
#[no_mangle]
pub extern "system" fn Java_ai_viewit_plugins_officeuniversal_OfficeUniversalPlugin_nativeCleanup(
    _env: JNIEnv,
    _class: JClass,
) {
    // Cleanup if needed
